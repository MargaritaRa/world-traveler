...
if __name__ == '__main__':
    with app.app_context():
        ...
        c = Countries(
            ...
            visa = "https://www.exteriores.gob.es/Embajadas/washington/en/Paginas/index.aspx",
        ...
        c = Countries(
            ...
            visa = "https://www.thaiembassy.com/thailand-visa/thai-visa",
        ...
        c = Countries(
            ...
            language = "Nepali",
            mannerism = "Namaste (a slight bow with palms pressed together) when greeting, remove shoes when entering homes or temples, avoid public displays of affection.",
            visa = "https://nyc.nepalconsulate.gov.np/visa/",
        ...
        c = Countries(
            ...
            visa = "https://visa.visitsaudi.com/",
        ...
        c = Countries(
            ...
            visa = "https://www.gov.br/mre/pt-br/consulado-miami/information-about-visas-in-english",
        ...
        c = Countries(
            ...
            visa = "https://www.aruba.com/us/traveler-health-requirements",
        ...
        c = Countries(
            ...
            visa = "https://www.embassyofjamaica.org/",
            phrases = "Hello: Hello, Goodbye: Goodbye, Thank you: Thank you, Sorry: Sorry, No: No",
            tipping = "10-15% in restaurants.",
        ...
        c = Countries(
            ...
            visa = "https://travel.state.gov/content/travel/en/international-travel/International-Travel-Country-Information-Pages/Samoa.html",
        ...
        c = Countries(
            ...
            visa = "https://embassies.gov.il/washington/ConsularServices/Pages/Visa-Information.aspx",
        ...
        n = NewsLetter(
            ...
            location = "Asia",
            message1 = "Many of us wanderlust travelers often come across this topic of conversation quite often. Picture this: I leave my desk job and embark on a tour through Asia, highlighting my favorite restaurants and bars. Beginning each morning in paradise, living out my dream. Simple right. I’ve definitely considered this in the past. Could I have stayed? Ya, but was I happy? No.",
            message2 = "My idea developed into an obsession, and that obsession became a reality. That reality came crashing down really quickly." ,
            message3 ="There’s a few things I didn’t think in my inital planning. First is how needy people can be, like I canthink for myself needsy. Second, is how I’ll be stuck working instead of traveling. Third, how I would end up with a manager from hell. Lastly how much I’ll dislike being a tour guide. While my story is quite long and could fill multiple chapters, there is one particular aspect I would like to mention. For those who have a strong wanderlust, I recommended to either keeping/finding a better job and travel during your free time.",
            likes = 5
            )
        ...
        n = NewsLetter(
            ...
            location = "The world",
            message1 = "If I received a penny for every time someone asked me why I travel despite having America to be in. Although I have a deep love for America, it is not the be-all and end-all. Why settle for a mere dollop of whipped cream when you have an entire cake right in front of you?",
            message2 = "Since the age of 21, I’ve been traveling nonstop. All of my travel experiences have made me wiser and stronger. I haenstly wouldn't know who I would be without it. The true beauty of traveling lies in the unknown. You can plan, calculate, and study, but there’s always an element of surprise.",
            message3 = "You can never anticipate the individuals you will encounter, the connections you will form, and the knowledge you will gain. Each time I return from a journey, I feel like I’ve discovered something new about myself; stepping out of your comfort zone can lead to that.Who cares about people’s opinions? If you have the desire to travel, simply go ahead and do it.",
            likes = 35
            )
